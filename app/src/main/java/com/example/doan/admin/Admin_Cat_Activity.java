...
public class Admin_Cat_Activity extends AppCompatActivity implements CategoryAdapter.OnCategoryActionListener {
        ...
        call.enqueue(new Callback<List<Category>>() {
            ...
            public void onResponse(Call<List<Category>> call, Response<List<Category>> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(Admin_Cat_Activity.this, "Không thể tải danh mục: " + response.code(), Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<List<Category>> call, Throwable t) {
                Toast.makeText(Admin_Cat_Activity.this, "Lỗi: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        call.enqueue(new Callback<Category>() {
            ...
            public void onResponse(Call<Category> call, Response<Category> response) {
                if (response.isSuccessful()) {
                    ...
                    categoryAdapter.updateList(categoryList);
                    clearInputs();
                    Toast.makeText(Admin_Cat_Activity.this, "Thêm danh mục thành công!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Admin_Cat_Activity.this, "Lỗi khi thêm: " + response.code(), Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void onEditClick(int categoryId) {
        Intent intent = new Intent(Admin_Cat_Activity.this, Admin_Cat_Edit_Activity.class);
        ...
        call.enqueue(new Callback<Map<String, String>>() {
            ...
            public void onResponse(Call<Map<String, String>> call, Response<Map<String, String>> response) {
                if (response.isSuccessful()) {
                    ...
                    categoryAdapter.updateList(categoryList);
                    Toast.makeText(Admin_Cat_Activity.this, "Xóa thành công!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Admin_Cat_Activity.this, "Lỗi khi xóa: " + response.code(), Toast.LENGTH_SHORT).show();
                }
            }
