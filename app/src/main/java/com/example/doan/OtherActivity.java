...
//                        Toast.makeText(OtherActivity.this, "Đã đăng xuất!", Toast.LENGTH_LONG).show();
//                    }
//                });
...
//                try {
//                    Intent intent = new Intent(OtherActivity.this, OrderActivity.class);
//                    startActivity(intent);
//                    updateButtonState( cartIcon);
//                } catch (Exception e) {
...
public class OtherActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Xử lý sự kiện nhấn btn_profile
        if (btnProfile != null) {
            btnProfile.setOnClickListener(v -> {
                Log.d(TAG, "Nhấn nút Hồ Sơ");
                fetchUserProfile();
        ...
        // Xử lý sự kiện nhấn btn_setting
        if (btnSetting != null) {
            btnSetting.setOnClickListener(v -> {
                Log.d(TAG, "Nhấn nút Cài Đặt");
                try {
