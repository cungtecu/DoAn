...
//        categoryRecyclerView.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false)); // Hiển thị ngang
//        productRecyclerView.setLayoutManager(new GridLayoutManager(this, 2));
//
//        // Khởi tạo danh sách
//        categoryList = new ArrayList<>();
...
//
//        // Khởi tạo adapter
//        categoryAdapter = new CategoryAdapter(categoryList, this::loadProductsByCategory);
//        productAdapter = new ProductAdapter(this, productList);
//
//        // Gán adapter
//        categoryRecyclerView.setAdapter(categoryAdapter);
...
//                    try {
//                        Log.e(TAG, "Error body: " + response.errorBody().string()); // Log chi tiết lỗi từ server
//                    } catch (Exception e) {
