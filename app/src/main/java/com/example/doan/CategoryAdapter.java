...
//                    .placeholder(android.R.drawable.ic_menu_gallery) // Dùng tài nguyên mặc định của Android
//                    .into(holder.categoryImage);
//        } else {
//            holder.categoryImage.setImageResource(android.R.drawable.ic_menu_gallery); // Dùng tài nguyên mặc định
//        }
//
//        if (category.getDescription() != null && !category.getDescription().isEmpty()) {
//            holder.categoryDescription.setText(category.getDescription());
